...
python3 test_demo.py --model_id 1 --data_dir [DATA_PATH]

# Final testing on Hybrid DIV2K + LSDIR set
python3 test_demo.py --model_id 1 --hybrid_test --data_dir [DATA_PATH]


### Inference Script [PLEASE NOTE]
   We have modified test_demo.py as per our need to handle our ensemble strategy.
   So kindly use our test_demo.py as it is which contains incremental changes over the github repo's code.
